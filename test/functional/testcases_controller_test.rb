...
class TestcasesControllerTest < ActionController::TestCase
  ...
  test "should create testcase" do
    assert_difference('Testcase.count') do
      post :create, testcase: { browser: @testcase.browser, capture: @testcase.capture, description: @testcase.description, name: @testcase.name, run: @testcase.run, task_ids: @testcase.task_ids }
    end
  ...
  test "should update testcase" do
    put :update, id: @testcase, testcase: { browser: @testcase.browser, capture: @testcase.capture, description: @testcase.description, name: @testcase.name, run: @testcase.run, task_ids: @testcase.task_ids }
    assert_redirected_to testcase_path(assigns(:testcase))
  end
